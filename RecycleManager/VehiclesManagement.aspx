    ...
    <div class="main">
        <div class="wrapper">
            <div class="register-user">
                ...
                <asp:SqlDataSource ID="sdsVehicles" runat="server" ConnectionString="<%$ ConnectionStrings:RecycleSystemConnection %>" DeleteCommand="DELETE FROM dbo.[Vehicle] WHERE [vehicle_id] = @vehicle_id"  SelectCommand="exec Vehicle_Get -10">
                    <DeleteParameters>
